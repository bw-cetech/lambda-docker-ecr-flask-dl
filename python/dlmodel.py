...
class Model():
    ...
    def runInference(self,dlImageArray):
        ...
        # .tflite model 
        interpreter = tflite.Interpreter(model_path='dev/python/tfliteConv-model.tflite') # looks for model in same folder. NB as we are setting up an instance of the MOdel class, the actual invocation is at the same level as main python script (main.py)
